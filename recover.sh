...
git ls-remote -h https://github.com/gelnana/nixos_config refactor
echo ""
...
if [[ $flake_path == "y" ]]; then
    ...
    echo "Recovering NixOS..."
    sudo nixos-install --no-root-password --flake "github:gelnana/nixos_config/${git_rev:-master}#$host"
fi
